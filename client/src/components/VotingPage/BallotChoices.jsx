    ...
    return (
        <div className="flex flex-col border border-black rounded">
            ...
            <div className="flex flex-col items-center px-4 py-4 bg-white rounded-b gap-4">
                ...
                <button className={`${selected ? "bg-amber-200" : "bg-white"} bg-white hover:brightness-90 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow`} onClick={() => voteButtonHandler(ballotChoice) }>Vote</button>
            </div>
        </div>
    );
}
